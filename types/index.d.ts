export namespace API {
  /** GET /api/currentUser */
  export interface GET_API_CURRENT_USER_QUERY {
    /** example:  123 */
    token: string
  }
  ...
  export interface GET_API_CURRENT_USER_RES {
  ...
  /** GET /api/rule */
  export interface GET_API_RULE_QUERY {
    /** example:  123 */
    token: string
    /** example: 1 */
    current: string
  ...
  export interface GET_API_RULE_RES {
  ...
  export interface POST_API_LOGIN_OUT_LOGIN_QUERY {
    /** example:  123 */
    token: string
  }
  ...
  export interface POST_API_LOGIN_OUT_LOGIN_RES {
    /** example: {} */
  ...
  export interface POST_API_LOGIN_ACCOUNT_QUERY {
    /** example:  123 */
    token: string
  }

  export interface POST_API_LOGIN_ACCOUNT_PAYLOAD {
    /** example: admin */
    username: string
    /** example: ant.design */
    password: string
  ...
  export interface POST_API_LOGIN_ACCOUNT_RES {
    /** example: ok */
    status: string
    /** example: account */
    type: string
